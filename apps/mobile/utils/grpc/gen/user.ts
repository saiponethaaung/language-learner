...
export namespace user {
    ...
    export class UserObject extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            id?: number;
            name?: string;
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UserObject {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new UserObject();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): UserObject {
            return UserObject.deserialize(bytes);
        }
    }
    ...
    export abstract class UnimplementedUserServiceService {
        static definition = {
            ...
            Profile: {
                ...
                responseSerialize: (message: UserObject) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => UserObject.deserialize(new Uint8Array(bytes))
            }
        };
        ...
        abstract Profile(call: grpc_1.ServerUnaryCall<dependency_1.common.EmptyRequest, UserObject>, callback: grpc_1.sendUnaryData<UserObject>): void;
    }
    export class UserServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedUserServiceService.definition, "UserService", {}) {
        ...
        Profile: GrpcUnaryServiceInterface<dependency_1.common.EmptyRequest, UserObject> = (message: dependency_1.common.EmptyRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<UserObject>, options?: grpc_1.CallOptions | grpc_1.requestCallback<UserObject>, callback?: grpc_1.requestCallback<UserObject>): grpc_1.ClientUnaryCall => {
